                ...
                <div class="card-body">
                    ...
                    <form action="{{ url("meal/$meal->id") }}" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="name" id="name" value="{{$meal->name}}" class="form-control" placeholder="* Enter meal name" aria-describedby="helpId">
                          <small id="helpId" class="text-muted">Meal name is the name of the meal.</small>
                        </div>

                        <div class="form-group">
                            <label for="price">Price</label>
                            <input type="text" name="price" id="price" value="{{$meal->price}}" class="form-control" placeholder="* Enter meal price" aria-describedby="helpId">
                            <small id="helpId" class="text-muted">How much was this meal?</small>
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea name="description" id="description" class="form-control" placeholder="* Enter meal description" aria-describedby="helpId" rows="3">{{$meal->description}}</textarea>
